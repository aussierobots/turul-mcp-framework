...
use mcp_protocol::{McpResult, prompts::{GetPromptResult, PromptMessage}};
use mcp_protocol::prompts::PromptDefinition;
...
pub fn prompt_to_descriptor(prompt: &dyn McpPrompt) -> mcp_protocol::prompts::Prompt {
    prompt.to_prompt()
}

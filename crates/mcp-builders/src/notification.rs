...
use mcp_protocol::notifications::{
    ...
    CancelledNotification, InitializedNotification,
...
impl NotificationBuilder {
    ...
    pub fn param(mut self, key: impl Into<String>, value: Value) -> Self {
        ...
        self.params.as_mut().unwrap().other.insert(key.into(), value);
        self
    }
...
mod tests {
    use super::*;
    use serde_json::json;
    use mcp_protocol::notifications::NotificationDefinition;
    ...
    fn test_progress_notification_builder() {
        ...
        assert_eq!(notification.params.message, Some("Processing files...".to_string()));
    ...
    fn test_cancelled_notification_builder() {
        ...
        assert_eq!(notification.params.reason, Some("User cancelled operation".to_string()));

        let meta = notification.params.meta.expect("Expected meta");
        assert_eq!(meta.get("cancellation_time"), Some(&json!("2025-01-01T00:00:00Z")));
    }
    ...
    fn test_custom_notifications() {
        ...
        let already_prefixed = NotificationBuilder::server_notification("notifications/already/prefixed")
            .build();

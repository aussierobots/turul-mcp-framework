...
///
/// Describes how a tool should be executed, including task support.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct ToolExecution {
    /// Whether the tool supports or requires task-based execution
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct Tool {
    ...
    /// Optional execution configuration (task support)
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct CallToolResult {
    ...
    /// Structured content that matches the tool's output schema (MCP 2025-11-25)
    #[serde(skip_serializing_if = "Option::is_none")]

...
use turul_mcp_protocol::{McpResult, CallToolResult};
...
mod tests {
    ...
    use turul_mcp_protocol::tools::{HasBaseMetadata, HasDescription, HasInputSchema, HasOutputSchema, HasAnnotations, HasToolMeta, ToolSchema, ToolAnnotations, ToolResult, CallToolResult};

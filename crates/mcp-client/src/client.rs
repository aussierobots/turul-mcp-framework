...
impl McpClient {
    ...
    /// Read a resource
    pub async fn read_resource(&self, uri: &str) -> McpClientResult<Vec<mcp_protocol_2025_06_18::ResourceContent>> {
    ...
    ) -> McpClientResult<Vec<mcp_protocol_2025_06_18::PromptMessage>> {

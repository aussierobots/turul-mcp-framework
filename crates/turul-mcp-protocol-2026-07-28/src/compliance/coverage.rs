...
pub const CASES: &[Case] = &[
    ...
    Case {
        dir: "CallToolRequestParams",
        kind: Kind::Params,
        parse_and_reserialize: roundtrip::<crate::tools::CallToolRequestParams>,
    },
    Case {
        dir: "CallToolResult",
        kind: Kind::Result,
        parse_and_reserialize: roundtrip::<crate::tools::CallToolResult>,
    },
    Case {
        dir: "CallToolResultResponse",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "CancelledNotification",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "CancelledNotificationParams",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ClientCapabilities",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
    ...
    Case {
        dir: "CompleteResultResponse",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "CreateMessageRequest",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "CreateMessageRequestParams",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "CreateMessageResult",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
    ...
    Case {
        dir: "ElicitRequestFormParams",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ElicitRequestURLParams",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
    ...
    Case {
        dir: "GetPromptRequest",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "GetPromptRequestParams",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
    ...
    Case {
        dir: "InvalidParamsError",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ListPromptsRequest",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ListPromptsResult",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ListPromptsResultResponse",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ListResourceTemplatesRequest",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ListResourceTemplatesResult",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ListResourceTemplatesResultResponse",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ListResourcesRequest",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ListResourcesResult",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ListResourcesResultResponse",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ListRootsRequest",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    ...
    Case {
        dir: "ListRootsResult",
        kind: Kind::Result,
        parse_and_reserialize: roundtrip::<crate::roots::ListRootsResult>,
    },
    ...
    Case {
        dir: "ListToolsResult",
        kind: Kind::Result,
        parse_and_reserialize: roundtrip::<crate::tools::ListToolsResult>,
    },
    Case {
        dir: "ListToolsResultResponse",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "LoggingMessageNotification",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "LoggingMessageNotificationParams",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "MethodNotFoundError",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "MissingRequiredClientCapabilityError",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ModelPreferences",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
    ...
    Case {
        dir: "ProgressNotification",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ProgressNotificationParams",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "PromptListChangedNotification",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ReadResourceRequest",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ReadResourceResult",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ReadResourceResultResponse",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "Resource",
        kind: Kind::Struct,
        parse_and_reserialize: roundtrip::<crate::resources::Resource>,
    },
    Case {
        dir: "ResourceLink",
        kind: Kind::NotModeled,
    ...
    Case {
        dir: "ResourceListChangedNotification",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ResourceUpdatedNotification",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ResourceUpdatedNotificationParams",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    ...
    Case {
        dir: "Root",
        kind: Kind::Struct,
        parse_and_reserialize: roundtrip::<crate::roots::Root>,
    },
    Case {
        dir: "SamplingMessage",
        kind: Kind::NotModeled,
    ...
    Case {
        dir: "SubscriptionsAcknowledgedNotification",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "SubscriptionsListenRequest",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
    ...
    Case {
        dir: "TextResourceContents",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "TitledMultiSelectEnumSchema",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "TitledSingleSelectEnumSchema",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "Tool",
        kind: Kind::Struct,
        parse_and_reserialize: roundtrip::<crate::tools::Tool>,
    },
    Case {
        dir: "ToolListChangedNotification",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "ToolResultContent",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
    ...
    Case {
        dir: "UnsupportedProtocolVersionError",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "UntitledMultiSelectEnumSchema",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
    Case {
        dir: "UntitledSingleSelectEnumSchema",
        kind: Kind::NotModeled,
        parse_and_reserialize: not_modeled,
    },
];

...
pub fn derive_mcp_sampling_impl(input: DeriveInput) -> Result<TokenStream> {
    ...
    let expanded = quote! {
        ...
        impl mcp_protocol::sampling::HasSamplingConfig for #struct_name {
        ...
        #[automatically_derived]
        impl mcp_protocol::sampling::HasSamplingContext for #struct_name {
            fn messages(&self) -> &[mcp_protocol::sampling::SamplingMessage] {
        ...
        #[automatically_derived]
        impl mcp_protocol::sampling::HasModelPreferences for #struct_name {
        ...
        impl mcp_server::McpSampling for #struct_name {
            async fn sample(&self, request: mcp_protocol::sampling::CreateMessageRequest) -> mcp_protocol::McpResult<mcp_protocol::sampling::CreateMessageResponse> {
        ...
        impl #struct_name {
            ...
            pub async fn sample_impl(&self, _request: mcp_protocol::sampling::CreateMessageRequest) -> Result<mcp_protocol::sampling::CreateMessageResponse, String> {
                // Default: return a simple response
                let response_message = mcp_protocol::sampling::SamplingMessage {
                ...
                Ok(mcp_protocol::sampling::CreateMessageResponse::new(response_message, model_name))
            }
        }
    };

...
//! then `cargo run -p streamable-http-client-2026-07-28`).
//!
...
//! - `call_tool_with_progress`: a request-scoped progress feed riding the
//!   POST response's SSE stream via `_meta.progressToken`.

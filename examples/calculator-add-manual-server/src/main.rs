...
impl HasOutputSchema for CalculatorAddTool {
    fn output_schema(&self) -> Option<&ToolSchema> { None } // No schema validation
}
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let server = McpServer::builder()
        ...
        .instructions("Add two numbers using fully manual implementation (Level 4 - Maximum Control)")

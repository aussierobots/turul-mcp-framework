...
| **conformance-fixture-server** | 2026-07-28 | `npx @modelcontextprotocol/conformance@0.2.0-alpha.11 server --requirements 2026-07-28` | Driven by upstream's suite — **not** a usage example, every name and payload is dictated by a scenario. Passes 37/37 scored scenarios; the `tasks-*` extension fixtures are still absent (unscored). See its [README](examples/conformance-fixture-server/README.md) (port 8010) |
